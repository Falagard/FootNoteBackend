...
Server.main = function() {
	...
	var router = new tink_web_routing_Router0(new Api());
	...
	container.run(new tink_http_middleware_Static("public_html","/static").apply(handler));
};
var Api = function() {
	this.api = new Root();
};
...
asys_FileSystem.absolutePath = function(relPath) {
	...
	return haxe_io_Path.join([haxe_io_Path.addTrailingSlash(process.cwd()),relPath]);
};
...
mime_Mime.get_extensions = function() {
	if(mime_Mime.extensions != null) {
		...
		while(_g < _g1.length) {
			var type = _g1[_g];
			++_g;
			var _g2 = mime_Mime.db[type];
			var _g3 = _g2.charset;
			var _g4 = _g2.compressible;
			var _g5 = _g2.source;
			var e = _g2.extensions;
			if(e != null) {
				var _g6 = 0;
				while(_g6 < e.length) {
					var extension = e[_g6];
...
tink_http_ChunkedParser.prototype = {
	...
	,progress: function(cursor) {
		if(this.chunkSize < 0) {
			...
			case 0:
				var v = _g.v;
				this.remaining = this.chunkSize = Std.parseInt("0x" + (v == null ? "null" : v.toString()));
				break;
			case 1:
				break;
			}
...
tink_http_Handler.toNodeHandler = function(this1,options) {
	...
	return function(req,res) {
		this1.process(new tink_http_IncomingRequest(req.socket.remoteAddress,tink_http_IncomingRequestHeader.fromIncomingMessage(req),body(req))).handle(function(out) {
			...
			var _g_current = 0;
			var _g_array = out.header.fields;
...
tink_http_OutgoingResponse.blob = function(code,chunk,contentType,headers) {
	...
	var fields = new tink_http_HeaderField("Content-Type".toLowerCase(),contentType);
		...
		return tink_core_Future.irreversible(function(cb) {
			...
			var onListen = function() {
				var onListen = tink_http_ContainerResult.Running({ shutdown : function(hard) {
					if(hard) {
						console.log("tink/http/containers/NodeContainer.hx:81:","Warning: hard shutdown not implemented");
					}
					return tink_core_Future.map(tink_core_Future.irreversible(function(cb) {
...
tink_web_routing_Context.prototype = {
	...
	,headers: function() {
		var _g = [];
		var _g_current = 0;
		var _g_array = this.request.header.fields;
		while(_g_current < _g_array.length) {
...
tink_web_routing_Router0.prototype = {
	route: function(ctx) {
		...
		if(ctx.part(0) == "api") {
			if(l > 0 == true) {
				...
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(404,"Not Found: [" + ctx.request.header.method + "] " + (this1.query == null ? this1.path : (this1.path == null ? "null" : this1.path) + "?" + (this1.query == null ? "null" : this1.query)),{ fileName : "Server.hx", lineNumber : 10, className : "tink.web.routing.Router0", methodName : "route"}))));
			}
		} else {
			var this1 = ctx.request.header.url;
			return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(404,"Not Found: [" + ctx.request.header.method + "] " + (this1.query == null ? this1.path : (this1.path == null ? "null" : this1.path) + "?" + (this1.query == null ? "null" : this1.query)),{ fileName : "Server.hx", lineNumber : 10, className : "tink.web.routing.Router0", methodName : "route"}))));
	...
	,api: function(ctx,__depth__) {
		...
		return tink_core_Promise.next(new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(this.target.api))),function(__target__) {
...
tink_web_routing_Router1.prototype = {
	route: function(ctx) {
		...
		if(_g == "GET") {
			if(l > 0) {
				if(l > 1 == false) {
					var name = _g1;
					return this.hello(ctx,name);
				} else {
					var this1 = ctx.request.header.url;
					return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(404,"Not Found: [" + ctx.request.header.method + "] " + (this1.query == null ? this1.path : (this1.path == null ? "null" : this1.path) + "?" + (this1.query == null ? "null" : this1.query)),{ fileName : "Server.hx", lineNumber : 19, className : "tink.web.routing.Router1", methodName : "route"}))));
				}
			} else {
				return this.hello(ctx,null);
			}
		} else {
			var this1 = ctx.request.header.url;
			return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(404,"Not Found: [" + ctx.request.header.method + "] " + (this1.query == null ? this1.path : (this1.path == null ? "null" : this1.path) + "?" + (this1.query == null ? "null" : this1.query)),{ fileName : "Server.hx", lineNumber : 19, className : "tink.web.routing.Router1", methodName : "route"}))));
	...
	,hello: function(ctx,name) {
		...
		return tink_core_Promise.next(new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(d.hello(d1)))),function(v) {
